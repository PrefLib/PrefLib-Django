...
def initialize_metadata():
	...
	metadata_num_alt.upperBounds.set([])
	metadata_num_alt.upperBounds.add(metadata_smal_ballot)
	metadata_num_alt.upperBounds.add(metadata_larg_ballot)
	metadata_num_alt.upperBounds.add(metadata_smal_indif)
	metadata_num_alt.upperBounds.add(metadata_larg_indif)
